...
class CreatePasienDirawatKomorbidsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pasien_dirawat_komorbids', function (Blueprint $table) {
            $table->id();
            $table->date('tanggal');
    ...
    {
        Schema::dropIfExists('pasien_dirawat_komorbids');
    }
}
