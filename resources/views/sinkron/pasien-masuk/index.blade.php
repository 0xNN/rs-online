  ...
  $(document).ready(function () {
    var table = $('#dt-rekap-pasien-masuk').DataTable({
      ...
      columns: [
        ...
        {data: 'igd_suspect_l', name: 'igd_suspect_l',searchable: false, orderable: false},
        {data: 'igd_suspect_p', name: 'igd_suspect_p',searchable: false, orderable: false},
        {data: 'igd_confirm_l', name: 'igd_confirm_l',searchable: false, orderable: false},
        {data: 'igd_confirm_p', name: 'igd_confirm_p',searchable: false, orderable: false},
        {data: 'rj_suspect_l', name: 'rj_suspect_l',searchable: false, orderable: false},
        {data: 'rj_suspect_p', name: 'rj_suspect_p',searchable: false, orderable: false},
        {data: 'rj_confirm_l', name: 'rj_confirm_l',searchable: false, orderable: false},
        {data: 'rj_confirm_p', name: 'rj_confirm_p',searchable: false, orderable: false},
        {data: 'ri_suspect_l', name: 'ri_suspect_l',searchable: false, orderable: false},
        {data: 'ri_suspect_p', name: 'ri_suspect_p',searchable: false, orderable: false},
        {data: 'ri_confirm_l', name: 'ri_confirm_l',searchable: false, orderable: false},
        {data: 'ri_confirm_p', name: 'ri_confirm_p',searchable: false, orderable: false},
        {data: 'tanggal_input', name: 'tanggal_input',searchable: false, orderable: false},
        {data: 'tanggal_sinkron', name: 'tanggal_sinkron',searchable: false, orderable: false},
      ],
      columnDefs: [ {
