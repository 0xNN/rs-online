...
@include('sinkron.data-sdm.modal')
  <div class="container-fluid">
    <div class="fade-in">
      ...
      <div class="card shadow-sm">
        <div class="card-header">Data SDM
          <a href="{{ route('data-sdm.create') }}" class="d-sm-inline-block btn btn-sm btn-success shadow-sm" id="tombol-utama">
            Tambah/Ubah
            {{-- <i class="cil-plus"></i> --}}
          </a>
        </div>
        <div class="card-body">
          {{-- <div class="table-responsive"> --}}
            <table id="dt-data-sdm" class="table table-sm table-bordered dt-responsive nowrap" style="width:100%">
...
<script>
  ...
  $(document).ready(function () {
    var table = $('#dt-data-sdm').DataTable({
      language: {
        url: '{{ asset('id.json') }}'
      },
      responsive: true,
      ...
      $("#form-tambah-edit").validate({
          submitHandler: function (form) {
              ...
              $.ajax({
                  ...
                  url: "{{ route('data-sdm.sinkronisasi') }}", //url simpan data
                  ...
                  success: function (data) { //jika berhasil
                      ...
                      var oTable = $('#dt-data-sdm').dataTable(); //inialisasi datatable
    ...
    $('body').on('click','.delete',function() {
      ...
      var url = "{{ route('data-sdm.destroy', ":dataId") }}";
        ...
        if (result.isConfirmed) {
          $.ajax({
            ...
            success: function (data) { //jika sukses
              setTimeout(function () {
                var oTable = $('#dt-data-sdm').dataTable();
                oTable.fnDraw(false); //reset datatable
              });
              Swal.fire(
                'Deleted!',
