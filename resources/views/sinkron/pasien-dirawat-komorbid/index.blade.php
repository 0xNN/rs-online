...
@include('sinkron.pasien-dirawat-komorbid.modal')
  <div class="container-fluid">
    <div class="fade-in">
      ...
      <div class="card shadow-sm">
        <div class="card-header">Data Rekap Pasien Dirawat Komorbid
          <a href="{{ route('pasien-dirawat-komorbid.create') }}" class="d-sm-inline-block btn btn-sm btn-success shadow-sm" id="tombol-utama">
            Tambah/Ubah
            {{-- <i class="cil-plus"></i> --}}
          </a>
        </div>
        <div class="card-body">
          {{-- <div class="table-responsive"> --}}
            <table id="dt-rekap-pasien-dirawat-komorbid" class="table table-sm table-bordered dt-responsive nowrap" style="width:100%">
...
<script>
  ...
  $(document).ready(function () {
    var table = $('#dt-rekap-pasien-dirawat-komorbid').DataTable({
      language: {
        url: '{{ asset('id.json') }}'
      },
      responsive: true,
      processing: true,
      serverSide: true,
      ajax: "{{ route('pasien-dirawat-komorbid.index') }}",
      columns: [
    ...
    $('body').on('click','.sinkron',function(){
      var id = $(this).data('id');
      $.get('pasien-dirawat-komorbid/'+id, function(data) {
      ...
      $("#form-tambah-edit").validate({
          submitHandler: function (form) {
              ...
              $.ajax({
                  ...
                  url: "{{ route('pasien-dirawat-komorbid.sinkronisasi') }}", //url simpan data
                  ...
                  success: function (data) { //jika berhasil
                      ...
                      var oTable = $('#dt-rekap-pasien-dirawat-komorbid').dataTable(); //inialisasi datatable
    ...
    $('body').on('click','.delete',function() {
      ...
      var url = "{{ route('pasien-dirawat-komorbid.destroy', ":dataId") }}";
        ...
        if (result.isConfirmed) {
          $.ajax({
            ...
            success: function (data) { //jika sukses
              setTimeout(function () {
                var oTable = $('#dt-rekap-pasien-dirawat-komorbid').dataTable();
                oTable.fnDraw(false); //reset datatable
              });
              Swal.fire(
                'Deleted!',
